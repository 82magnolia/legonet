...
home_dir  = "/home/jhkim/Projects/legonet"


### 3D-FRONT dataset (optional)
tdfront_dir =  os.path.join(home_dir, "dataset", "3D-FRONT-LEGONet")
future_model_dir = os.path.join(tdfront_dir, "3D-FUTURE-model")
front_dir = os.path.join(tdfront_dir, "3D-FRONT")
path_to_floor_plan_textures = os.path.join(home_dir, "dataset", "ATISS/demo/floor_plan_texture_images")
...
eval_dir = os.path.join(home_dir, "results")